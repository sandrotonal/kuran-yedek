                    ...
                    >
                        ...
                        <div className="flex gap-2 justify-center relative z-10">
                            <button
                                ...
                                className={`w-full py-3 px-4 rounded-xl font-medium transition-colors shadow-lg active:scale-95 flex items-center justify-center gap-2
                                    ${favorites.includes(selectedName.number)
                                        ? 'bg-emerald-100 border border-emerald-500 text-emerald-600 dark:bg-emerald-900/40 dark:border-emerald-500/50 dark:text-emerald-400 shadow-emerald-900/20'
                                        : 'bg-theme-bg border border-theme-border hover:border-emerald-500/50 hover:text-emerald-500'
                                    }
                                `}
                            >
                                {favorites.includes(selectedName.number) ? (
